<script lang="ts">
	...
	const content = {
		...
		ru: {
			metaTitle: 'Ski Box и Прокат | Chalet du Soleil',
			metaDescription:
				'Общие уличные ski-box и отапливаемая комната для ботинок рядом с ресепшеном в Торньоне. Прокат снаряжения через нашего местного партнера.',
			heroLabel: 'Хранение и снаряжение · Торньон',
			heroTitle: 'Ski Box и Прокат',
			heroText: 'Общие уличные ski-box и отапливаемая комната для ботинок рядом с ресепшеном.',
			introTitle: 'Все, что вам нужно, уже здесь, в отеле.',
			introText:
				'Для максимального удобства мы предлагаем общие уличные ski-box для лыж и сноубордов, а также общую отапливаемую комнату для ботинок рядом с ресепшеном. Помещение отапливается, но сушилки для ботинок нет. Благодаря сотрудничеству с местным прокатом вы можете заранее забронировать снаряжение и получить его уже готовым в отеле.',
			storageLabel: 'Хранение снаряжения',
			storageTitle1: 'Общие',
			storageTitle2: 'Ski Box',
			storageText1:
				'Ski-box расположены снаружи отеля, в выделенной зоне рядом с ресепшеном. Они общие и не отапливаются, но удобны для хранения лыж и сноубордов между катаниями.',
			storageText2:
				'Расположение всего в нескольких шагах от входа и трассы позволяет быстро забрать снаряжение и без лишних переходов отправиться к подъемникам.',
			storageFeature1: 'Общие боксы',
			storageFeature2: 'Уличная зона',
			bootsLabel: 'Ботинки',
			bootsTitle1: 'Отапливаемая',
			bootsTitle2: 'Комната для ботинок',
			bootsText1:
				'Лыжные ботинки хранятся в общей комнате, расположенной в отдельном помещении рядом с ресепшеном.',
			bootsText2:
				'Помещение отапливается, поэтому утром ботинки менее холодные и их комфортнее надевать. Сушилки для ботинок нет, но отдельное пространство помогает держать все в порядке и под защитой.',
			bootsFeature1: 'Отапливаемое помещение',
			bootsFeature2: 'Рядом с ресепшеном',
			stats: [
				{ value: 'Общие', label: 'Ski-box' },
				{ value: 'Улица', label: 'Расположение' },
				{ value: 'Отапливается', label: 'Комната для ботинок' },
				{ value: '50м', label: 'До трассы' }
			],
			rentalTitle: 'Прокат снаряжения',
			rentalSubtitle: 'В сотрудничестве с нашим местным партнером',
			rentalCards: [
				{
					title: 'Лыжи и сноуборды',
					subtitle: 'Полный комплект',
					text: 'Горные лыжи, сноуборд, ботинки, палки и шлем. Снаряжение подготавливается и настраивается под ваш уровень и потребности.'
				},
				{
					title: 'Готово в отеле',
					subtitle: 'Без очередей и стресса',
					text: 'Забронируйте до приезда, и мы все организуем с местным партнером, чтобы ваше снаряжение уже ждало вас в отеле.'
				},
				{
					title: 'Поддержка во время отдыха',
					subtitle: 'Помощь на месте',
					text: 'Проблемы с креплениями? Ботинки неудобны? Наш партнер поможет с заменой и регулировкой во время вашего пребывания.'
				}
			],
			ctaButton: 'Забронировать снаряжение',
			howTitle: 'Как это работает',
			howSubtitle: 'В 4 простых шага',
			steps: [
				{
					title: 'Онлайн-заявка',
					text: 'Заполните форму, указав ваши предпочтения и даты проживания.'
				},
				{
					title: 'Подтверждение',
					text: 'Наш партнер свяжется с вами, чтобы подтвердить наличие и стоимость.'
				},
				{
					title: 'Подготовка',
					text: 'Снаряжение подготавливается до вашего приезда и передается в отель.'
				},
				{
					title: 'На склон',
					text: 'Заберите комплект и сразу начинайте день на снегу.'
				}
			],
			finalTitle: 'Готовы кататься?',
			finalText:
				'Забронируйте снаряжение сейчас и отдыхайте без лишних забот. Наш партнер подготовит все до вашего приезда.',
			form: {
				successTitle: 'Запрос отправлен!',
				successText:
					'Ваш почтовый клиент открылся со всеми деталями. Отправьте письмо, чтобы завершить запрос.',
				headerTitle: 'Бронирование снаряжения',
				headerText: 'Заполните форму и отправьте запрос нашему партнеру',
				...
				type: 'Тип *',
				level: 'Уровень *',
				adultBoot: 'Размер ботинок (взрослый)',
				childBoot: 'Размер ботинок (ребенок)',
				includeHelmet: 'Добавить шлем (рекомендуется)',
				notes: 'Дополнительные примечания',
				notesPlaceholder: 'Особые запросы, размеры для нескольких человек и т.д.',
				submit: 'Отправить запрос партнеру',
				submitHelp: 'Откроется ваш почтовый клиент с уже заполненными данными',
				emailSubjectPrefix: 'Запрос на прокат',
				emailHeading: 'ЗАПРОС НА ПРОКАТ СНАРЯЖЕНИЯ',
				guestData: 'ДАННЫЕ ГОСТЯ',
				period: 'ПЕРИОД',
				equipmentSection: 'СНАРЯЖЕНИЕ',
				...
				typeLabel: 'Тип',
				levelLabel: 'Уровень',
				adultBootLabel: 'Размер взрослых ботинок',
				childBootLabel: 'Размер детских ботинок',
				toDefine: 'Уточнить позже',
				helmetLabel: 'Шлем',
				yesIncluded: 'Да, включен',
				no: 'Нет',
				sentFromSite: 'Отправлено с сайта Chalet du Soleil',
				placeholderName: 'Иван Иванов',
				placeholderEmail: 'ivan@email.com',
				placeholderPhone: '+7 999 1234567',
				placeholderAdultBoot: 'например 42, 43.5',
				placeholderChildBoot: 'например 32, 35'
			},
			equipmentLabels: {
				sci: 'Горные лыжи',
				snowboard: 'Сноуборд',
